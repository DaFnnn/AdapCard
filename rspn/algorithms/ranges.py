...
class NominalRange:
    ...
    def __init__(self, possible_values, null_value=None, is_not_null_condition=False, attr=None, table=None):
...
class NumericRange:
    ...
    def __init__(self, ranges, inclusive_intervals=None, null_value=None, is_not_null_condition=False, attr=None,
                 table=None):
        self.is_not_null_condition = is_not_null_condition
        self.ranges = ranges
        self.null_value = null_value
