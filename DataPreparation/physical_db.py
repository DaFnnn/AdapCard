...
from Inference.utils import gen_full_join_query, print_conditions


class DBConnection:

    def __init__(self, db_user="postgres", db_password="postgres", db_host="202.199.6.74", db_port="5432", db="card"):
...
# db = DBConnection(db_host="30.249.192.114")
# db.vacuum()